...
export default function Music() {
  ...
  useEffect(() => {
    loadAudio();
    return unloadAudio; // Limpa o objeto de áudio quando o componente é desmontado
  }, []);
  ...
  // Use o useFocusEffect para pausar a música quando sair da tela
  useFocusEffect(
    React.useCallback(() => {
      return () => pauseSound();
    }, [])
  ...
  // Função de limpeza para descarregar o objeto de áudio
